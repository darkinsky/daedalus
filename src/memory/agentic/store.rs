...
// modify only these constants.

const METADATA_SYSTEM_PROMPT: &str =
...
const LINK_VALIDATION_SYSTEM_PROMPT: &str =
...
const EVOLUTION_SYSTEM_PROMPT: &str =
...
fn link_validation_prompt(note_text: &str, candidates_text: &str) -> String {
    format!(
...
fn evolution_prompt(existing_note_text: &str, new_note_text: &str) -> String {
    format!(
